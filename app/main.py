...
# Lost Pet
@app.post('/api/v1/lost-pets/{owner_id}/', response_model=schemas.LostPet, status_code=status.HTTP_201_CREATED)
...
@app.get('/api/v1/lost-pets', response_model=List[schemas.LostPet])
...
@app.get('/api/v1/lost-pets/{lost_pet_id}', response_model=schemas.LostPet)
...
@app.put('/api/v1/lost-pets/{lost_pet_id}', response_model=schemas.LostPet)
...
@app.delete('/api/v1/lost-pets/{lost_pet_id}', status_code=status.HTTP_204_NO_CONTENT)
...
@app.post('/api/v1/lost-pets/found/{lost_pet_id}', response_model=schemas.LostPet)
